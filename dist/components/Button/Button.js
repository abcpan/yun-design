...
var Button = function (props) {
    ...
    if (btnType === "link" && href) {
        return (React.createElement("a", __assign({ className: classes, href: href, onClick: onClick }, restProps), children));
    }
    return (React.createElement("button", __assign({ className: classes, disabled: disabled, onClick: onClick }, restProps), children));
};
Button.defaultProps = {
    disabled: false,
    btnType: "primary"
